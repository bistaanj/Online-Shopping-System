	...
	<!-- Div of a first product starts here -->
		<div class="container">
			...
			<!-- this div contains price -->
				...
				<div class="price">&#x20B9 55 <br><a href="#"><span style="font-size: 22px;">add to cart</span></a> <!--Add to cart ko reference-->
		...
		<div class="container">
			...
			<!-- this div contains price -->
				...
				<div class="price">  &#x20B9 55 <br><a href="#"><span style="font-size: 22px;">add to cart</span></a>
				 </div>
			 </div> 
			 <!-- This div contains the product details -->
			<div class="content">
